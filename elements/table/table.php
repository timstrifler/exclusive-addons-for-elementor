...
class ExadTable extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Table', 'exclusive-addons-elementor' );
    }

    public function get_icon() {
        return 'exad-element-icon eicon-table';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new ExadTable() );