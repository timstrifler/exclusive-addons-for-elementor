...
class Exad_Exclusive_Tabs extends Widget_Base {
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .exad-advance-tab' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .exad-advance-tab' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .exad-advance-tab',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .exad-advance-tab' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			[
            	'name' => 'exad_exclusive_tab_title_typography',
				'selector' => '{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .exad-advance-tab.exad-tabs-vertical .exad-tabs-nav > ul' => 'min-width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li i' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li img' => 'width: {{SIZE}}{{UNIT}};',
				]
			]
		);
		$this->add_responsive_control(
			'exad_exclusive_tab_icon_gap',
			[
		...
		$this->add_responsive_control(
			'exad_exclusive_tab_padding',
			[
				'label' => esc_html__( 'Padding', 'exclusive-addons-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		$this->add_responsive_control(
			'exad_exclusive_tab_margin',
			[
				'label' => esc_html__( 'Margin', 'exclusive-addons-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		...
		$this->start_controls_tabs( 'exad_exclusive_tabs_header_tabs' );
			...
			$this->start_controls_tab( 'exad_exclusive_tabs_header_normal', [ 'label' => esc_html__( 'Normal', 'exclusive-addons-elementor' ) ] );
				$this->add_control(
					'exad_exclusive_tab_color',
					[
						'label' => esc_html__( 'Tab Background Color', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#f1f1f1',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'default' => '#333',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					'exad_exclusive_tab_icon_color',
					[
						'label' => esc_html__( 'Icon Color', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#333',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li i' => 'color: {{VALUE}};',
						],
						'condition' => [
							'exad_exclusive_tabs_icon_show' => 'yes'
						]
				...
				$this->add_group_control(
					Group_Control_Border::get_type(),
					[
						'name' => 'exad_exclusive_tab_border',
						'label' => esc_html__( 'Border', 'exclusive-addons-elementor' ),
						'selector' => '{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li',
					]
				);
				$this->add_responsive_control(
					'exad_exclusive_tab_border_radius',
					[
						'label' => esc_html__( 'Border Radius', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em', '%' ],
						'selectors' => [
			 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			 			],
					]
				);
			...
			$this->start_controls_tab( 'exad_exclusive_tabs_header_hover', [ 'label' => esc_html__( 'Hover', 'exclusive-addons-elementor' ) ] );
				$this->add_control(
					'exad_exclusive_tab_color_hover',
					[
						'label' => esc_html__( 'Tab Background Color', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#f1f1f1',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li:hover' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					'exad_exclusive_tab_text_color_hover',
					[
						'label' => esc_html__( 'Text Color', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#333',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li:hover' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					'exad_exclusive_tab_icon_color_hover',
					[
						'label' => esc_html__( 'Icon Color', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#333',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li:hover .fa' => 'color: {{VALUE}};',
						],
						'condition' => [
							'exad_exclusive_tabs_icon_show' => 'yes'
						]
				...
				$this->add_group_control(
					Group_Control_Border::get_type(),
					[
						'name' => 'exad_exclusive_tab_border_hover',
						'label' => esc_html__( 'Border', 'exclusive-addons-elementor' ),
						'selector' => '{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li:hover',
					]
				);
				$this->add_responsive_control(
					'exad_exclusive_tab_border_radius_hover',
					[
						'label' => esc_html__( 'Border Radius', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em', '%' ],
						'selectors' => [
			 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			 			],
					]
				);
			$this->end_controls_tab();
			...
			$this->start_controls_tab( 'exad_exclusive_tabs_header_active', [ 'label' => esc_html__( 'Active', 'exclusive-addons-elementor' ) ] );
				$this->add_control(
					'exad_exclusive_tab_color_active',
					[
						'label' => esc_html__( 'Tab Background Color', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#444',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active' => 'background-color: {{VALUE}};',
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active-default' => 'background-color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					...
					[
						...
						'default' => '#fff',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active' => 'color: {{VALUE}};',
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active-default' => 'color: {{VALUE}};',
						],
					]
				);
				$this->add_control(
					'exad_exclusive_tab_icon_color_active',
					[
						'label' => esc_html__( 'Icon Color', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#fff',
						'selectors' => [
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active .fa' => 'color: {{VALUE}};',
							'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active-default .fa' => 'color: {{VALUE}};',
						],
						'condition' => [
							'exad_exclusive_tabs_icon_show' => 'yes'
						]
				...
				$this->add_group_control(
					Group_Control_Border::get_type(),
					[
						'name' => 'exad_exclusive_tab_border_active',
						'label' => esc_html__( 'Border', 'exclusive-addons-elementor' ),
						'selector' => '{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active, {{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active-default',
					]
				);
				$this->add_responsive_control(
					'exad_exclusive_tab_border_radius_active',
					[
						'label' => esc_html__( 'Border Radius', 'exclusive-addons-elementor' ),
						'type' => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em', '%' ],
						'selectors' => [
			 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li.active-default' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			 			],
					]
				);
			$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .exad-advance-tab .exad-tabs-content > div' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '#333',
				'selectors' => [
					'{{WRAPPER}} .exad-advance-tab .exad-tabs-content > div' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .exad-advance-tab .exad-tabs-content > div',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-content > div' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .exad-advance-tab .exad-tabs-content > div' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li:after' => 'border-width: {{SIZE}}px; bottom: -{{SIZE}}px',
					'{{WRAPPER}} .exad-advance-tab.exad-tabs-vertical .exad-tabs-nav > ul li:after' => 'right: -{{SIZE}}px; top: calc(50% - {{SIZE}}px) !important;',
				],
				'condition' => [
					'exad_exclusive_tab_caret_show' => 'yes'
				]
			]
		);
		$this->add_control(
			'exad_exclusive_tab_caret_color',
			[
				'label' => esc_html__( 'Caret Color', 'exclusive-addons-elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#444',
				'selectors' => [
					'{{WRAPPER}} .exad-advance-tab .exad-tabs-nav > ul li:after' => 'border-top-color: {{VALUE}};',
					'{{WRAPPER}} .exad-advance-tab.exad-tabs-vertical .exad-tabs-nav > ul li:after' => 'border-top-color: transparent; border-left-color: {{VALUE}};',
				],
				'condition' => [
					'exad_exclusive_tab_caret_show' => 'yes'
				]
	...
	protected function render() {
		...
		if($settings['exad_exclusive_tab_caret_show'] != 'yes')
	...
	<div <?php echo $this->get_render_attribute_string('exad_tab_wrapper'); ?> data-tabs>
        ...
        <?php foreach( $settings['exad_exclusive_tabs'] as $tab ) : $exad_find_default_tab[] = $tab['exad_exclusive_tab_show_as_default'];?>
            ...
            <p><?php echo do_shortcode( $tab['exad_exclusive_tab_content'] ); ?></p>
