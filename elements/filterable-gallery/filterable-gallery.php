		...
		<div class="exad-gallery one">
          <div id="exad-gallery-one">
            <div id="filters" class="exad-gallery-menu">
              ...
              <button class="filter-item" data-filter=".art">Art Direction</button>
              <button class="filter-item" data-filter=".concept">Concept</button>
              <button class="filter-item" data-filter=".design">Design</button>
              <button class="filter-item" data-filter=".illustration">Illustration</button>
            </div>
            <div class="exad-gallery-element">
              <div class="exad-gallery-item art">
                <img src="images/image-gallery/gallery-one-1.jpg" alt="Gallery-1">
                <div class="exad-gallery-item-overlay">
                  <div class="exad-gallery-item-overlay-content">
                    <a href="images/image-gallery/gallery-one-1.jpg" class="image-view-one"><i class="fa fa-search"></i></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
                </div>
              </div>
              <div class="exad-gallery-item concept illustration">
                <img src="images/image-gallery/gallery-one-2.jpg" alt="Gallery-1">
                <div class="exad-gallery-item-overlay">
                  <div class="exad-gallery-item-overlay-content">
                    <a href="images/image-gallery/gallery-one-2.jpg" class="image-view-one"><i class="fa fa-search"></i></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
                </div>
              </div>
              <div class="exad-gallery-item concept art">
                <img src="images/image-gallery/gallery-one-3.jpg" alt="Gallery-1">
                <div class="exad-gallery-item-overlay">
                  <div class="exad-gallery-item-overlay-content">
                    <a href="images/image-gallery/gallery-one-3.jpg" class="image-view-one"><i class="fa fa-search"></i></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
                </div>
              </div>
              <div class="exad-gallery-item design art">
                <img src="images/image-gallery/gallery-one-4.jpg" alt="Gallery-1">
                <div class="exad-gallery-item-overlay">
                  <div class="exad-gallery-item-overlay-content">
                    <a href="images/image-gallery/gallery-one-4.jpg" class="image-view-one"><i class="fa fa-search"></i></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
                </div>
              </div>
              <div class="exad-gallery-item design metal">
                <img src="images/image-gallery/gallery-one-5.jpg" alt="Gallery-1">
                <div class="exad-gallery-item-overlay">
                  <div class="exad-gallery-item-overlay-content">
                    <a href="images/image-gallery/gallery-one-5.jpg" class="image-view-one"><i class="fa fa-search"></i></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
                </div>
              </div>
              <div class="exad-gallery-item illustration art">
                <img src="images/image-gallery/gallery-one-6.jpg" alt="Gallery-1">
                <div class="exad-gallery-item-overlay">
                  <div class="exad-gallery-item-overlay-content">
                    <a href="images/image-gallery/gallery-one-6.jpg" class="image-view-one"><i class="fa fa-search"></i></a>
                    <a href="#"><i class="fa fa-link"></i></a>
                  </div>
                </div>
              </div>
