<?php
/**
 * Plugin Name: Exclusive Addons Elementor - Pro (Free)
...
if ( ! class_exists( 'Exclusive_Addons_Elementor' ) ) {
	...
	final class Exclusive_Addons_Elementor {
		...
		public function includes() {
			...
			include_once EXAD_PATH . 'extensions/section-pattern.php';
			// Admin Dashboard
		...
		public function init() {
			...
			// Initiate Extensions
			\Exclusive_Addons\Elementor\Extensions\Section_Pattern::init();
			// Add Body Class 
