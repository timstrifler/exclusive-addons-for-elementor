jQuery(document).ready(function($) {
	...
	$( '.exad-get-pro' ).on( 'click', function() {
		swal({
	...
	$('.exad-checkbox input[type="checkbox"]').on( 'click', function( e ) {
	...
	$( '.js-exad-settings-save' ).on( 'click', function(event) {
