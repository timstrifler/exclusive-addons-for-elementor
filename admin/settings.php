		  	...
		  	<form action="" method="POST" id="exad-settings" name="exad-settings">
		  		...
		  		<div class="exad-header-bar">
					<div class="exad-header-left">
						...
						<h2 class="title"><?php _e( 'Exclusive Addons Settings', 'exclusive-addons-elementor' ); ?></h2>
					</div>
					<div class="exad-header-right">
					<button type="submit" class="button exad-btn js-exad-settings-save"><?php _e('Save settings', 'exclusive-addons-elementor'); ?></button>
					</div>
						...
						<div class="row exad-admin-general-wrapper">
							<div class="row exad-admin-block-banner">
		      					<a href="https://essential-addons.com/elementor/" target="_blank">
		      						<img class="exad-preview-img" src="<?php echo plugins_url( '/', __FILE__ ).'assets/images/settings-banner-bg.png'; ?>">
		      					</a>
				      		...
				      		<div class="col-full">
								...
								<div class="exad-checkbox-container">
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Contact Form 7', 'exclusive-addons-elementor' ); ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Count Down', 'exclusive-addons-elementor' ); ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Creative Button', 'exclusive-addons-elementor' ); ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Fancy Text', 'exclusive-addons-elementor' ); ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Post Grid', 'exclusive-addons-elementor' ); ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Post Timeline', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Product Grid', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Team Member', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Testimonials', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										<input type="checkbox" id="weforms" name="weforms" <?php checked( 1, $this->exad_get_settings['weforms'], true ); ?> >
										<label for="weforms"></label>
										<p class="exad-el-title"><?php _e( 'weForms', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
									...
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Dual Color Header', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Pricing Table', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Ninja Form', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Gravity Form', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Caldera Form', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
									 	<input type="checkbox" id="wpforms" name="wpforms" <?php checked( 1, $this->exad_get_settings['wpforms'], true ); ?> >
										<label for="wpforms"></label>
										<p class="exad-el-title"><?php _e( 'WPForms', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Twitter Feed', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Facebook Feed', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Filterable Gallery', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Data Table', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Image Accordion', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Content Ticker', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										<input type="checkbox" id="tooltip" name="tooltip" <?php checked( 1, $this->exad_get_settings['tooltip'], true ); ?> >
										<label for="tooltip"></label>
										<p class="exad-el-title"><?php _e( 'Tooltip', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Advanced Accordion', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										<input type="checkbox" id="adv-tabs" name="adv-tabs" <?php checked( 1, $this->exad_get_settings['adv-tabs'], true ); ?> >
										<label for="adv-tabs"></label>
										<p class="exad-el-title"><?php _e( 'Advanced Tabs', 'exclusive-addons-elementor' ) ?></p>
									</div>
									<div class="exad-checkbox">
										...
										<p class="exad-el-title"><?php _e( 'Progress Bar', 'exclusive-addons-elementor' ) ?></p>
									</div>
