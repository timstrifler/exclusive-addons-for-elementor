...
final class Base {
    ...
    function exad_admin_notice_pro_release() {
        ...
        $message = sprintf(
            ...
            <span>Don\'t miss the <b>Black Friday</b> deal of <b>FLAT 50 Percent discount</b> on all of our packages. <br/> P.S. The offer will be valid till December 10th, 2020. %1$s</span>', 'exclusive-addons-elementor' ),
