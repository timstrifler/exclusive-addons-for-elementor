...
if ( ! defined( 'EXAD_PLUGIN_VERSION' ) ) define( 'EXAD_PLUGIN_VERSION', '2.6.2' );
...
function exad_initiate_plugin() {
	...
	if ( ! class_exists( 'Classic_Editor' ) && ! class_exists( 'ShopCred\Base' ) && ( ! get_option( 'exad_blocks_notice_hide' ) ) ) {
